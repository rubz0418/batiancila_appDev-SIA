        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
                <div class="text-right">
                    <p class="text-gray-700 text-xs">Regular User</p>
                    <p class="font-medium text-sm text-gray-900">{{ auth()->user()->email }}</p>
                </div>
                <div class="bg-gradient-to-r from-blue-500 to-indigo-500 p-2 rounded-full">
        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <section class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl shadow-xl p-6 text-white card-hover fade-in">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-white text-xs">Total Users</p>
                ...
                <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-2xl shadow-xl p-6 text-white card-hover fade-in" style="animation-delay: 0.1s">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-white text-xs">Temperature</p>
                ...
                <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-2xl shadow-xl p-6 text-white card-hover fade-in" style="animation-delay: 0.2s">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-white text-xs">Search Results</p>
            ...
            <section class="mb-8 fade-in" style="animation-delay: 0.3s">
                <div class="bg-white rounded-2xl shadow-xl p-6 card-hover">
                    ...
                    <form method="GET" action="/user/dashboard" class="flex flex-col sm:flex-row gap-3">
                        <div class="flex-1 relative">
                            <input type="text" 
                                   name="search" 
                                   value="{{ $search ?? '' }}" 
                                   placeholder="Search users by name or full name..." 
                        ...
                        @if($search)
                            <a href="/user/dashboard" class="px-6 py-3 bg-gray-200 text-gray-700 font-semibold rounded-lg hover:bg-gray-300 transition-all duration-200">
                ...
                <div class="bg-white rounded-2xl shadow-xl p-6">
                    <div class="flex items-center justify-between mb-6">
                        <div class="flex items-center">
                            ...
                            <h2 class="text-lg font-bold text-gray-900">Users Directory</h2>
                        </div>
                        @if($search)
            ...
            <section class="fade-in" style="animation-delay: 0.5s">
                <div class="bg-white rounded-2xl shadow-xl p-6">
                    <div class="flex items-center mb-6">
                        ...
                        <h2 class="text-lg font-bold text-gray-900">Weather Information</h2>
                    </div>
